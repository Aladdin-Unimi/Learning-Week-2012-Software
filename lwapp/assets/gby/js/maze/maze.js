...
Maze.init = function(blockly) {
  ...
  finishIcon.style.top = ( Maze.mapOffsetTop_ +
      Maze.SIZE * (Maze.finish_.y + 0.5) - finishIcon.offsetHeight ) + "px";
  finishIcon.style.left = ( Maze.mapOffsetLeft_ +
      Maze.SIZE * (Maze.finish_.x + 0.5) - finishIcon.offsetWidth / 2 ) + "px";
...
/**
 * Returns the user's code in raw JavaScript.
 */
Maze.getCode = function() {
  var code = Blockly.Generator.workspaceToCode('JavaScript');
